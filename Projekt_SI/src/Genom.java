...
public class Genom implements Comparable {
    ...
    public Genom(int numberOfCities, int[][] travelPrices, int startingCity){
    ...
    public Genom(List<Integer> permutationOfCities, int numberOfCities, int[][] travelPrices, int startingCity){
